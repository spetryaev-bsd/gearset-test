<?xml version="1.0" encoding="utf-8"?><Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <flowAccesses>
        ...
        <flow>CloudNewsTriggerProcess</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>CountTask</flow>
    ...
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Cross_Sell_Lead_Completed_Activity_Count</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>TEEEST</flow>
    ...
    <classAccesses>
        <apexClass>TestingDeployCallbackContext</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <classAccesses>
        <apexClass>WorkflowRuleTest</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Lead.Completed_Activity_Count__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Notorious__b.Wishes__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Opportunity.Assigned_SE__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
